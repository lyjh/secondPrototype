...
public class Backpack {
 ...
 // All available items
     ...
     {"alarmclock", "alarmclock2", "antenna", "bat", "beaker",
      ...
      "gift", "gramphone", "guitar", "gun", "hammer",
      ...
      "paint", "pallet", "pallet2", "pencil", "rader",
      "radio", "ribbon", "safe", "satellite", "search",
      "shovel", "snowflake", "snowman", "spanner", "star",
      "star2", "stethoscope", "sun", "sunglasses", "syringe",
      "telescope", "tellurion", "thermometer", "tool", "torch",
      "treasure", "tree", "trompete", "umbrella", "video",
      "video2", "violin", "violin2", "watch", "whistel",
      "witchhat"};
     ...
     { R.drawable.alarmclock_silhouette, 	R.drawable.alarmclock2_silhouette,
       ...
       R.drawable.pencil_silhouette, 		R.drawable.rader_silhouette, 
       ...
       R.drawable.tellurion_silhouette, 	R.drawable.thermometer_silhouette,
       R.drawable.tool_silhouette, 			R.drawable.torch_silhouette,
       R.drawable.treasure_silhouette, 		R.drawable.tree_silhouette,
       R.drawable.trompete_silhouette, 		R.drawable.umbrella_silhouette,
     ...
     { 
		 ...
		 R.drawable.pencil, 		R.drawable.rader, 
		 ...
		 R.drawable.tellurion, 		R.drawable.thermometer,
		 R.drawable.tool, 			R.drawable.torch,
		 R.drawable.treasure, 		R.drawable.tree,
		 R.drawable.trompete, 		R.drawable.umbrella,
